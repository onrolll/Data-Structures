...
public class UnitTestsFirstLastList
{
    ...
    public void Add2Items_First3Items_ShouldThrowException()
    {
        ...
        // Act
        Assert.Throws<ArgumentOutOfRangeException>(() => items.First(3).ToList());
    }
    ...
    public void Add2Items_Last3Items_ShouldThrowException()
    {
        ...
        // Act
        Assert.Throws<ArgumentOutOfRangeException>(() => items.Last(3).ToList());
    }
    ...
    public void Add3Items_Min4Items_ShouldThrowException()
    {
        ...
        // Act
        Assert.Throws<ArgumentOutOfRangeException>(() => items.Min(4).ToList());
    }
    ...
    public void Add3Items_Max4Items_ShouldThrowException()
    {
        ...
        // Act
        Assert.Throws<ArgumentOutOfRangeException>(() => items.Max(4).ToList());
    }
